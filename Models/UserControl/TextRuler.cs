...
namespace TextRuler.TextRulerControl
{
    internal partial class TextRuler : UserControl
    {
        ...
        private void DrawIndents(Graphics g)
        {
            ...
            g.DrawImage(GMRTTranscription.Properties.Resources.l_indet_pos_upper, items[2]);
            g.DrawImage(GMRTTranscription.Properties.Resources.l_indent_pos_lower, items[3]);
            g.DrawImage(GMRTTranscription.Properties.Resources.r_indent_pos, items[4]);
        }
        ...
        private void DrawTabs(Graphics g)
        {
            ...
            {
                g.DrawImage(GMRTTranscription.Properties.Resources.tab_pos, tabs[i]);
            }            
        }
        #endregion
